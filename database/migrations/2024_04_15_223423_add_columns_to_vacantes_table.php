...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('vacantes', function (Blueprint $table) {
            ...
            $table->string("imagen"); //* Guardar ubicacion, no la imagen completa
    ...
    public function down(): void
    {
        Schema::table('vacantes', function (Blueprint $table) {
            ...
            //* Eliminar llaves foraneas para no generar vacios en la bd
            ...
            //* Eliminar uno por uno, si la migracion es para crear la tabla se puede eliminar todo
