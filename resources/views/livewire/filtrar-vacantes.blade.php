<div class="bg-gray-100 py-10">
    <h2 class="text-2xl md:text-4xl text-gray-600 text-center font-bold my-5">Buscar y Filtrar Vacantes</h2>
    ...
    <div class="max-w-7xl mx-auto">
        <form wire:submit='leerDatosFormulario'>
            ...
            <div class="flex justify-end">
                <input 
                    type="submit"
                    class="bg-indigo-500 hover:bg-indigo-600 transition-colors text-white text-sm font-bold px-10 py-2 rounded-lg cursor-pointer uppercase w-full md:w-auto"
                    value="Buscar"
                />
            </div>
        </form>
